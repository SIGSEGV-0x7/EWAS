...
# Query BY originalUrl
print("\n")
print("Query by originalUrl:\n")
start_time = time.time()
process = psutil.Process(os.getpid())
print(result[result.originalUrl == 'http://www.rohitab.com/discuss/?app=members&app=members&module=list&showall=0&sort_key=joined&sort_order=asc&max_results=20&quickjump=B&name_box=begins&name=B&quickjump=M'])
